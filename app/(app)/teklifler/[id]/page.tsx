    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href={`/api/teklifler/${id}/pdf`} target="_blank" rel="noopener noreferrer">
      ...
      {(teklif.mesaj || teklif.notlar || teklif.odeme_sartlari) && (
        <div className="mt-5 grid grid-cols-1 gap-3.5">
          {teklif.mesaj && (
            <Panel>
              <div className="mb-1 text-[11px] uppercase tracking-wide text-text-dim">Müşteriye Mesaj</div>
